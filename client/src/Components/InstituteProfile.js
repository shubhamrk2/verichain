  ...
  return (
    ...
    <div>
      ...
      <div className='header'>
        ...
        <h4 className='affiliation'>Approved by All India Council for Technical Education (AICTE), New Delhi.<br></br>
UG programs are Accredited by National Board of Accreditation (NBA), New Delhi.<br></br>
Affiliated to Dr APJ Abdul Kalam Technical University, Uttar Pradesh, Lucknow</h4>
</div>
      </div>
      ...
      <div className='bodyInner'>
        ...
        YOUR FUTURE OF EXCELLENCE BEGINS HERE<br/>
OUR COMMITMENT TO QUALITY AND EXCELLENCE MEANS THAT WE ONLY HAVE TRAINED STAFF FOR INNOVATIVE TEACHING AND REALTIME LEARNING PROCESS
        </p>
      </div>
      </div>
